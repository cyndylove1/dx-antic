...
const sr = ScrollReveal ({
 ...
 sr.reveal('.second-div-text, .text-content, .section-text,.swiper-wrapper,.inspire-text, .slide-img,.footer-container,.footer-content,.footer-icon-content,.bottom-end', {delay:350, origin:'bottom'})
